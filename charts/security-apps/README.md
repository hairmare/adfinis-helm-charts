...
![Version: 0.54.1](https://img.shields.io/badge/Version-0.54.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| vault.targetRevision | string | `"0.21.0"` | [vault Helm chart](https://github.com/hashicorp/vault-helm) version |
